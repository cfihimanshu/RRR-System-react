          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <button
                ...
                className={`flex-1 sm:flex-none px-6 py-3 rounded-2xl text-[10px] md:text-xs font-black transition-all flex items-center justify-center gap-2 uppercase tracking-widest ${hasSodToday
              ...
              <button
                ...
                className={`flex-1 sm:flex-none px-6 py-3 rounded-2xl text-[10px] md:text-xs font-black transition-all flex items-center justify-center gap-2 uppercase tracking-widest ${user?.role !== 'Admin' && !hasSodToday
