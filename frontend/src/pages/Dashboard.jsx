...
const FAQTab = React.lazy(() => import('../components/tabs/FAQTab'));
...
const ProtectedRoute = ({ children, allowedRoles, id }) => {
  ...
  const hasAccess = id === 'user-manual' || id === 'faq' || (id === 'internal-search' && user.canAccessRecords) || TAB_ACCESS[id]?.includes(user?.role);
        ...
        <div className={`flex-1 overflow-auto transition-all duration-300 ease-in-out`}>
          ...
          <Routes>
            ...
            <Route path="/faq" element={
              <ProtectedRoute id="faq"><FAQTab /></ProtectedRoute>
            } />
